      ...
      <div className="payment-summery">
        <div className="top-section-payment">
          ...
          <div className="discount-size">
            <h5>Discount</h5>
            <h5>-${totalPrice - totalPriceDiscount}</h5>
          </div>
        ...
        <div className="bottom-section-payment">
          ...
          <button disabled={(location.pathname === "/checkout" && step !== 3) || cartItems.length === 0} className="go-to-checkout" onClick={handlePlaceOrder}>
            {buttonText}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
