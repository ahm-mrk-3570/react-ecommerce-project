...
const OrderView = ({ order, onClose }) => {
  ...
  // Stop click bubbling so overlay onClick doesn't close the card
      ...
      <div className="ov-body">
        <div className="ov-meta-strip">
          <div className="ov-meta-cell">
            ...
            <span className="ov-meta-val">{order?.updated_at}</span>
          </div>
          <div className="ov-meta-sep" />
          <div className="ov-meta-cell">
            <span className="ov-meta-label">Products</span>
            <span className="ov-meta-val">{order?.order_items.length} items</span>
          </div>
          <div className="ov-meta-sep" />
          <div className="ov-meta-cell">
          ...
          <div className="ov-items-row">
            ...
            {extraCount > 0 && (
              <div className="ov-item">
                <div className="ov-thumb ov-thumb-extra">
                  <span>+{extraCount}</span>
                </div>
                <span className="ov-item-name">more items</span>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="ov-section ov-delivery-section">
            ...
            <div className="ov-delivery-row">
              ...
              <div className="ov-delivery-text">
                ...
                <span className="ov-delivery-val">{order?.shipping_city + order?.shipping_country}</span>
              </div>
            </div>
